...
- [News 184: Approximating sum types in Python with Pydantic][184]
  - 介绍了 Pydantic 库的使用，好像有点东西，但我没看懂

- [News 183: Sort, sweep, and prune: Collision detection algorithms][183]

  [184]: https://blog.yossarian.net/2024/08/12/Approximating-sum-types-in-Python-with-Pydantic
  [183]: https://leanrada.com/notes/sweep-and-prune/

## 2024-08-13

- [News 182: unix-and-linux-sysadmin-notes][182]
  - 介绍 Linux 操作的入门书籍，这是该书的原文仓库，可以免费阅读。

- [News 181: Exploring TLS certificates and their limits][181]
  - 在这篇长文中，作者演示如何手动生成一张网站的 TLS 证书，详细讲解了每个字段的含义。

- [News 180: You can deeplink to a specific PDF page][180]
  - Just append `#page=X` to your URL

  [182]: https://github.com/abdoufermat5/unix-and-linux-sysadmin-notes
  [181]: https://0x00.cl/blog/2024/exploring-tls-certs/
  [180]: https://technicalwriting.dev/www/pdf.html

## 2024-08-12

- [News 179: 阴云密布，2024年上半年汽车半导体产业总结（下，包括高通、英伟达、Mobileye）][179]
- [News 178: 阴云密布，2024年上半年汽车半导体产业总结（上）][178]

- [News 177: 问界M9的E/E架构分析][177]
  - 问界M9的E/E架构基本上是交叉域架构中最先进的，拥有千兆以太网和多达6个域控制器，受限于芯片性能和网络带宽，仍然不是中央计算或者说Zonal架构。

- [News 176: 极氪009之 E/E架构分析][176]
  - 极氪完全继承沃尔沃的技术，是国内唯一使用Flexray总线的厂家。

  [179]: https://db.shujubang.com/home/login/index/gid/20833
  [178]: https://db.shujubang.com/home/login/index/gid/20832
  [177]: https://db.shujubang.com/home/login/index/gid/20775
  [176]: https://db.shujubang.com/home/login/index/gid/20837

## 2024-08-09

- [News 175: DistroSea: 在线试用各种 Linux 发行版，它会分配一个虚拟机，浏览器里连接桌面][175]
- [News 174: 027xiguapi/code-box: 本插件可以用于CSDN/知乎/脚本之家/博客园等网站,实现无需登录一键复制代码等][174]
- [News 173: win-vind: 这个工具为 Windows 系统提供 Vim 风格的快捷键，也可以把它当作 Windows 的快捷键设定器][173]
- [News 172: Zulip: 一个开源的群聊软件，有服务端和各种平台的客户端][172]
- [News 171: Tunnelmole: 一个简单易用的隧道工具，不需要配置，只要一行命令，就让公网可以访问内网服务。][171]
...
- [News 169: gohugoio/hugo: The world’s fastest framework for building websites][169]
  ...
  [175]: https://distrosea.com/
  [174]: https://github.com/027xiguapi/code-box
  [173]: https://pit-ray.github.io/win-vind/
  [172]: https://github.com/zulip/zulip/
  [171]: https://tunnelmole.com/
